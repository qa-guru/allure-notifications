...
| **6.\*** | Allure 3 | TypeScript / typescript-go · CLI · builder · A3 plugin · AI | **Product** on `master` — pin `docs/allure-notifications/VERSION` (**6.0.8**) |

Monorepo pin = **6.0.8**. Product packages: npm **`allure-notifications`** + scoped `@allure-notifications/*` (CLI + plugin aligned at **6.0.8**).
