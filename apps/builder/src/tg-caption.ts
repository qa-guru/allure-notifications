...
export const TG_PREVIEW_STATS: Readonly<TgPreviewStats> = Object.freeze({
...
export const TG_PREVIEW_LINKS: Readonly<Record<string, string>> = Object.freeze({
...
export const TG_LINK_KEYS = Object.freeze(['report', 'dashboard', 'testops', 'build'] as const);
 ...
 * @param {string} lang
 */
export function phrasesFor(lang: string) {
 ...
 * @param {number} total
 */
export function formatPercentage(input: number, total: number) {
...
export function setTgPreviewStatsForTest(stats: TgPreviewStats | null) {
