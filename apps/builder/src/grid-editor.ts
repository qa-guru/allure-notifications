...
export function setGridForTest(g: GridStack | null) {
  grid = g;
}

export function setSuppressSyncForTest(v: boolean) {
  suppressSync = v;
}
 ...
 */
function cardCornerRadiusLogical(chartW: number, chartH: number): number {
 ...
 */
export function canvasDisplayScale(canvas: HTMLElement): number {
 ...
 * @param {HTMLElement} canvas
 */
export function canvasDisplayHeight(canvas: HTMLElement) {
 ...
 * @param {boolean} on
 */
export function setGridAnimate(on: boolean) {
  if (!grid) return;
 ...
 * @param {ChartItem} b
 */
export function rectsOverlap(a: ChartItem, b: ChartItem) {
 ...
 */
export function clampItem(raw: Partial<ChartItem> & { type: string; id?: string }): ChartItem | null {
...
/** @returns {ChartItem[]} */
export function readItemsFromGrid(): ChartItem[] {
  if (!grid) return [];
...
export function selectItem(el: HTMLElement | null): void {
 ...
 * @param {ChartItem} item
 */
export function makeWidgetEl(item: ChartItem) {
...
export function addItem(
  panelId: string,
  opts: { w?: number; h?: number; x?: number; y?: number; preferX?: number; preferY?: number } = {},
) {
 ...
 */
export function copyItem(el: HTMLElement) {
 ...
 * @param {HTMLElement} el
 */
export function deleteItem(el: HTMLElement) {
  if (!grid || !el) return;
...
export function onGridResizeStart(_ev: unknown, el: unknown) {
  stopLiveResizeMocks();
...
export function onGridResizeStop(_ev: unknown, el: unknown) {
  stopLiveResizeMocks();
