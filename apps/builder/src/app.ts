...
const CANVAS_TESTS_TABLE_POOL: TestsTableRowMockOpts[] = [
  {
    name: 'shouldLogin…',
...
function canvasTestsTableMaxRows(hostH: number, headerH: number, rowH: number): number {
...
function syncCanvasTestsTables(root?: ParentNode | null): void {
