 ...
 * @param {unknown} value
 */
export function vectorHash(value) {
 ...
 * @param {string} raw
 */
export function normalizeVectorId(raw) {
 ...
 * @param {Record<string, unknown>} snap
 */
export function fingerprintFromSnap(snap) {
 ...
 * @param {Record<string, unknown>} snap
 */
export function rememberSnap(snap) {
...
export function setVectorDraft(v) {
    vectorDraft = v;
}
export function getVectorMiss() {
    return vectorMiss;
}
export function setVectorMiss(v) {
    vectorMiss = v;
}
