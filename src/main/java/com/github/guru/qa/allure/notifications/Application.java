...
public class Application {
    ...
    public static void main(String[] args) {
        LOG.info("\n==========PROPERTIES==========\nbuild.launch.name: {}\nbuild.env: {}\nbuild.report.link: {}" +
                        ...
                        "\nmessenger: {}\nmattermost.api.url: {}", buildLaunchName(), buildEnvironment(),
                buildReportLink(), enableChart(), botToken(), chatId(), projectName(),
                allureReportFolder(), messenger(), mattermostApiUrl());
