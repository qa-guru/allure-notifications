    ...
    public ST message(TemplateData data) {
        ...
        return new ST(
                "<asterisk>Результати:<asterisk> \n" +
                        ...
                        "<bullet> <asterisk>Усього сценаріїв:<asterisk> " + data.getTotal() + '\n' +
                        "<bullet> <asterisk>Середовище:<asterisk> " + data.getEnvironment() + '\n' +
                        "<bullet> <asterisk>Усього успішних тестів:<asterisk> " + data.getPassed() + '\n' +
                        "<bullet> <asterisk>Усього невдалих тестів:<asterisk> " + data.getFailed() + '\n' +
